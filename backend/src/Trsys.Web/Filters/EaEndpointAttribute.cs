...
public class EaEndpointAttribute : ActionFilterAttribute
{
    ...
    public override async Task OnActionExecutionAsync(ActionExecutingContext context, ActionExecutionDelegate next)
    {
        ...
        var key = context.HttpContext.Request.Headers["X-Ea-Id"];
        var type = context.HttpContext.Request.Headers["X-Ea-Type"];
        var version = context.HttpContext.Request.Headers["X-Ea-Version"];
        ...
        context.HttpContext.User = SecretKeyClaimsPrincipalFactory.Create(secretKey.Id, secretKey.Key, secretKey.KeyType);
        await base.OnActionExecutionAsync(context, next);
    }
