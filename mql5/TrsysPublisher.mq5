...
string TradingData()
{
   ...
   {  
      ...
      //only forex
      PreTradingData += IntegerToString(ticket)+":"+StringSubstr(orderSymbol,0,6)+":"+IntegerToString(orderType)+":"+DoubleToString(orderOpenPrice)+":"+DoubleToString(orderLots)+":"+StringFormat("%i",orderOpenTime);
   }
