...
namespace Trsys.Web.Tests
{
    ...
    public class EaApi_OrdersTests
    {
        ...
        public async Task PostApiOrders_should_return_ok_given_single_order()
        {
            ...
            var res = await client.PostAsync("/api/ea/orders", new StringContent("1:USDJPY.0jp:0:1:2:3", Encoding.UTF8, "text/plain"));
            Assert.AreEqual(HttpStatusCode.OK, res.StatusCode);
            ...
            Assert.AreEqual("USDJPY.0jp", orders[0].OriginalSymbol);
